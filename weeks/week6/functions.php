...
$my_arrray = area_volume(10, 5, 20);
echo '<b>This is my area:</b>'.$my_arrray[0].' </br>'; //$my_array[0] 0 is the first variable, order 0, 1, 2, 3 etc
echo '<b>This is my volume:</b>'.$my_arrray[1].' </br>';
