...
if($new_temp <=60){
    ...
    // if sales is equal or less than 119999, then you receive 5%
    // if sales is equal or less than 139999, then you receive 10%
    // if sales is equal or less than 149999, then you receive 15%
