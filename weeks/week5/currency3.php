...
<!--time for our radio button that has an additional attribute VALUE-->  
            ...
            <option value="banner"
                <?php
                if(isset($_POST['bank']) && $_POST['bank'] == 'banner')
                echo 'selected = "selected"'
                ;?>
                >Banner Bank</option>
            <option value="wells"
            ...
            <option value="becu"
                ...
                echo 'selected = "selected"'
                ;?>
                >Boeing Employee Credit Union</option>
            </select>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(empty($_POST['email'])){
        echo'<p class="error">Please fill out your email!
        </p>';
    }

    if(empty($_POST['amount'])){
        echo'<p class="error">Please fill out your amount!
        </p>';
    }

    if(empty($_POST['currency'])){
        echo'<p class="error">Please check your currency!
        </p>';
    }

    if($_POST['bank'] == NULL){
        echo'<p class="error">Please choose your banking institution!
        </p>';
    }
